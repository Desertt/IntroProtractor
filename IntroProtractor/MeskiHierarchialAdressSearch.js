describe('Protractor Demo App', function () {
    ...
    var password = element(by.xpath('//*[@id="loginForm"]/div/div/div[4]/input'));
    var loginButton = element(by.xpath('//*[@id="loginForm"]/div/div/div[6]/div/button'));
    ...
    //#region Functions
    beforeEach(function () {
        browser.get('http://cbstest.meski.gov.tr/Web');
